      ...
      <div className="container-flex">
        <div className="container-1">
          ...
          <div className="text-1">
            We engineer tailored digital platforms aligned with your operations
            and long-term strategy. From concept to deployment, we build
            scalable solutions that move your business forward.
          </div>
        </div>
        <div className="container-1">
          <div className="container-top">
